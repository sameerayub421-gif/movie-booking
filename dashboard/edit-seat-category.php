...
$select_query = "SELECT * FROM seat_categories WHERE category_id='$id'";
...
<div class="container-fluid pt-4 px-4">
    <div class="bg-secondary rounded p-4">
        <h4 class="text-white mb-4">Edit Seat Category</h4>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="category_name" class="form-control bg-dark text-white border-0" required>
                        <option value="Gold" <?php if($category['category_name']=='Gold') echo 'selected'; ?>>Gold</option>
                        <option value="Platinum" <?php if($category['category_name']=='Platinum') echo 'selected'; ?>>Platinum</option>
                        <option value="Box" <?php if($category['category_name']=='Box') echo 'selected'; ?>>Box</option>
                    </select>
                </div>
